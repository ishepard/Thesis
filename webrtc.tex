...
\begin{itemize}
	...
	\item Alice set her local description to her offer.
	\item Alice uses a signaling mechanism to send her offer to Bob.
	\item Bob set his remote description to Alice's offer, so that his RTCPeerConnection knows about Alice's setup.
